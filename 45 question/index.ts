...
//  and division operations that each result in the number 8. Be sure to enclose
...
//  a array called names. Print each person’s
...
//  three people you’d like to invite to dinner. Then use your list to print a
...
//  to add one new guest to the end of your list. • Print a new 
//  set of invitation messages, one for each person in your list.
...
// • Reverse the order of your list again. Print the list to 
...
//   or anything else you’d like. Write a program that creates 
...
// • If the person is age 65 or older, print 
// a message that the person is an elder.
...
//QUESTION 31
// No Users: Add an if test to Exercise 28 to make sure the 
...
//  the name of the pizza instead of printing just the 
//  name of the pizza. For each pizza you should have one 
